  ...
  <el-header class="header">
    <div class="header-container">
      ...
      <div class="header-center">
        ...
        <div class="equipment-management" :class="{ 'active-tab': $route.path === '/schedule-management' }" @click="goScheduleManagement">
          <img loading="lazy" alt="" src="@/assets/header/schedule.png" :style="{ filter: $route.path === '/schedule-management' ? 'brightness(0) invert(1)' : 'None' }" />
          日程管理
        </div>
        ...
        <el-dropdown v-if="isSuperAdmin" trigger="click" class="equipment-management more-dropdown"
          :class="{ 'active-tab': $route.path === '/dict-management' || $route.path === '/params-management' || $route.path === '/provider-management' || $route.path === '/server-side-management' || $route.path === '/face-management' }"
          @visible-change="handleParamDropdownVisibleChange">
          <span class="el-dropdown-link">
            <img loading="lazy" alt="" src="@/assets/header/param_management.png"
              :style="{ filter: $route.path === '/dict-management' || $route.path === '/params-management' || $route.path === '/provider-management' || $route.path === '/server-side-management' || $route.path === '/face-management' ? 'brightness(0) invert(1)' : 'None' }" />
            参数字典
          ...
          <el-dropdown-menu slot="dropdown">
            ...
            <!-- 隐藏人脸模块管理入口 - 保留功能但不在菜单中显示 -->
            <!-- <el-dropdown-item @click.native="goFaceManagement">
              人脸模块管理
            </el-dropdown-item> -->
          </el-dropdown-menu>
        </el-dropdown>
...
export default {
  ...
  methods: {
    ...
    goFaceManagement() {
      this.$router.push('/face-management')
    },
    fetchUserInfo() {
