...
--
-- Host: localhost    Database: xiaozhi_esp32_server
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=1963436486688780293 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Agent与插件的唯一映射表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_schedule` (
  ...
  `content` varchar(500) NOT NULL COMMENT 'æ—¥ç¨‹å†…å®¹',
  `schedule_date` date NOT NULL COMMENT 'æ—¥ç¨‹æ—¥æœŸ',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'çŠ¶æ€ 0-æœªå®Œæˆ 1-å·²å®Œæˆ',
...
) ENGINE=InnoDB AUTO_INCREMENT=1963450307880955906 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='ç”¨æˆ·æ—¥ç¨‹è¡¨';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_user` (
  ...
  `creator` bigint DEFAULT NULL COMMENT '创建者',
  `update_date` datetime DEFAULT NULL COMMENT '更新时间',
  `real_name` varchar(100) DEFAULT 'root' COMMENT 'ç”¨æˆ·å§“å',
  `secret_id` varchar(255) DEFAULT 'root' COMMENT 'è…¾è®¯äº‘secret_id',
  `secret_key` varchar(255) DEFAULT 'root' COMMENT 'è…¾è®¯äº‘secret_key',
  `face_encoding` text,
...
-- Dump completed on 2025-09-04 20:42:36
